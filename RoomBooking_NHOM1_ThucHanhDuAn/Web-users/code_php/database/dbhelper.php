...
// ------------ Multi Query and Rollback If Any - Hàm để thực hiện Insert, Update, Delete và (Return Number Column Success)
function MultiexecuteAndRollBack($sql) {
	//save data into table
	// open connection to database
	$con = mysqli_connect(HOST, USERNAME, PASSWORD, DATABASE);
	// Insert, update, delete
	$Row_Sucess = $con -> multi_query($sql);
	//close connection
	mysqli_close($con);
